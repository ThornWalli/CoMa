...
(function(mod) {
  if (typeof exports == "object" && typeof module == "object") // CommonJS
    module.exports = mod();
  else if (typeof coma.define === 'function' && coma.define.amd) // AMD
    return coma.define('cm/lib/codemirror',[], mod);
...
(function(mod) {
  if (typeof exports == "object" && typeof module == "object") // CommonJS
    ...
    coma.define('cm/mode/clike/clike',["../../lib/codemirror"], mod);
  else // Plain browser env
    mod(CodeMirror);
})(function(CodeMirror) {
"use strict";
...
(function(mod) {
  if (typeof exports == "object" && typeof module == "object") // CommonJS
    ...
    coma.define('cm/mode/xml/xml',["../../lib/codemirror"], mod);
  else // Plain browser env
    mod(CodeMirror);
})(function(CodeMirror) {
"use strict";
...
(function(mod) {
  if (typeof exports == "object" && typeof module == "object") // CommonJS
    ...
    coma.define('cm/mode/css/css',["../../lib/codemirror"], mod);
  else // Plain browser env
    mod(CodeMirror);
})(function(CodeMirror) {
"use strict";
...
(function(mod) {
  if (typeof exports == "object" && typeof module == "object") // CommonJS
    ...
    coma.define('cm/mode/javascript/javascript',["../../lib/codemirror"], mod);
  else // Plain browser env
    mod(CodeMirror);
})(function(CodeMirror) {
"use strict";
...
(function(mod) {
  if (typeof exports == "object" && typeof module == "object") // CommonJS
    ...
    coma.define('cm/mode/htmlmixed/htmlmixed',["../../lib/codemirror", "../xml/xml", "../javascript/javascript", "../css/css"], mod);
  else // Plain browser env
    mod(CodeMirror);
})(function(CodeMirror) {
  "use strict";
...
(function(mod) {
  if (typeof exports == "object" && typeof module == "object") // CommonJS
    ...
    coma.define('cm/mode/php/php',["../../lib/codemirror", "../htmlmixed/htmlmixed", "../clike/clike"], mod);
  else // Plain browser env
    mod(CodeMirror);
})(function(CodeMirror) {
  "use strict";
...
(function(mod) {
  if (typeof exports == "object" && typeof module == "object") // CommonJS
    ...
    coma.define('cm/mode/sql/sql',["../../lib/codemirror"], mod);
  else // Plain browser env
    mod(CodeMirror);
})(function(CodeMirror) {
"use strict";
