  ...
  public function base($class, $path = null)
  {
    ...
    if (strpos($class, 'CoMa\Base') > -1) {
      ...
      $classes = [
        ...
        'CoMa\Base\TemplateArea' => 'TemplateArea.php',
        'CoMa\Base\TemplateComponent' => 'TemplateComponent.php',
        ...
        'CoMa\Base\PropertyDialog\BlankField' => 'propertyDialog/Field.php',
      ];
  ...
  public function helper($class, $path = null)
  {
    if (strpos($class, 'CoMa\Helper') > -1) {
      ...
      $classes = [
        ...
        'CoMa\Helper\Template' => 'Template.php',
